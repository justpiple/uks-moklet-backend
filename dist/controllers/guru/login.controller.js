...
var Login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, match, id_admin, email, name, akses, token, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, guru_query_1.findGuruByEmail)(req.body.email)];
            case 1:
                user = _a.sent();
                ...
                akses = user === null || user === void 0 ? void 0 : user.akses;
                token = jsonwebtoken_1.default.sign({ id: id_admin, name: name, email: email, role: akses }, process.env.JWT_SECRET, {
                    expiresIn: "15d",
                });
