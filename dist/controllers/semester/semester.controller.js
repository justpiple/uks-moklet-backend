...
var GetAllSemester = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, semester_query_1.getAllSemester)()];
            case 1:
                response = _a.sent();
                if (response == null) {
                ...
                return [2 /*return*/, res
                        .status(200)
                        .json((0, apiResponse_1.Success)("Semester loaded successfully", { data: response }))];
            case 2:
                error_1 = _a.sent();
                console.log(error_1);
...
// FIND SEMESTER BY ID
var FindSemesterById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, semester_query_1.findSemesterById)(req.params.id)];
            case 1:
                response = _a.sent();
                if (response == null) {
                    return [2 /*return*/, res.status(400).json((0, apiResponse_1.BadRequest)("Cannot find any semester"))];
...
// CREATE NEW SEMESTER
var CreateSemester = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res
                        .status(200)
                        .json((0, apiResponse_1.CreatedSuccessfully)("Semester created successfully", { data: response }))];
            case 2:
                error_3 = _a.sent();
                console.log(error_3);
...
// DELETE SEMESTER
var DeleteSemester = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, semester_query_1.deleteSemester)(req.params.id)];
            case 1:
                response = _a.sent();
                if (!response) {
                    return [2 /*return*/, res.status(400).json((0, apiResponse_1.BadRequest)("Cannot find any semester"))];
