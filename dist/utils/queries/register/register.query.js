...
exports.deleteRegister = exports.updateRegister = exports.createRegister = exports.getAllRegister = exports.findRegisterById = void 0;
...
function createRegister(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.register.create({ data: data })];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response];
            }
...
function updateRegister(id, data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.register.update({ where: { id: id }, data: data })];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response];
            }
...
function deleteRegister(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.register.delete({ where: { id: id } })];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response];
            }
