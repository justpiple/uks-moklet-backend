...
function findGuruByEmail(email) {
    return __awaiter(this, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.findGuruByEmail = findGuruByEmail;
...
function createGuru(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.guru.create({ data: data })];
                case 1:
                    create = _a.sent();
...
function updateGuru(id, data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.guru.update({
                        where: { id: id },
                        data: data,
                    })];
                case 1:
...
function deleteGuru(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.default.guru.delete({
                        where: { id: id },
                    })];
                case 1:
                    deleteUser = _a.sent();
